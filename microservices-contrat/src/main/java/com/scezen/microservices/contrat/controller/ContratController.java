package com.scezen.microservices.contrat.controller;
...
import com.scezen.microservices.contrat.dao.ContratRepository;
...
public class ContratController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Contrat> findById(@PathVariable Integer id) {
